...
<div class="hero-wrap js-fullheight" style="background-image: url(<?php echo e($city->image_url); ?>);">
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="<?php echo e(route('home')); ?>">Hotels in <?php echo e($city->name); ?></a></h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-3 sidebar">
                ...
                <div class="sidebar-wrap bg-light ftco-animate">
                    ...
                    <form action="<?php echo e(route('city', ['slug' => $city->slug])); ?>" method="GET">
                        <div class="fields">
                            <div class="form-group">
                                <div class="select-wrap one-third">
                                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dinhmanh/Desktop/booking/resources/views/list_hotel.blade.php ENDPATH**/ ?>
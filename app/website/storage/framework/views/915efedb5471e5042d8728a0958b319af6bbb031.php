...
<div class="hero-wrap js-fullheight" style="background-image: url(https://thuthuatnhanh.com/wp-content/uploads/2020/10/hinh-anh-da-lat-binh-minh-mo-ao.jpg);">
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
            <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <h3 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href=""> Tìm kiếm Hotels theo từ khóa "<?php echo e($search); ?>" </a></h3>
                <?php if(isset($city)): ?>
        ...
        <div class="row">
            <div class="col-lg-3 sidebar">
                ...
                <div class="sidebar-wrap bg-light ftco-animate">
                    ...
                    <form action="<?php echo e(route('search', $search)); ?>" method="GET">
                        <div class="fields">
                            <div class="form-group">
                                <div class="select-wrap one-third">
                                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dinhmanh/Desktop/booking/resources/views/search.blade.php ENDPATH**/ ?>
  ...
  border-radius: 5px;
    ...
    <nav class="pagination">
        <ul class="">
            ...
            <?php else: ?>
                <li>
                    <a class="page-numbers" href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>">&lsaquo;</a>
                </li>
            <?php endif; ?>
...
<?php /**PATH /home/dinhmanh/Desktop/booking/resources/views/vendor/pagination/default.blade.php ENDPATH**/ ?>
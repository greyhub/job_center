                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-9 col-md-9">
                                <div class="menu-wrapper">
                                    ...
                                    <div class="main-menu">
                                        <nav class="d-none d-lg-block">
                                            <ul id="navigation">
                                                ...
                                                <?php if(Auth::check()): ?>
                                                <li><a href="<?php echo e(route('user.profile')); ?>">Hồ sơ</a></li>
                                    ...
                                    <a href="<?php echo e(route('register')); ?>" class="btn head-btn1">Đăng ký</a>
                                    <a href="<?php echo e(route('login')); ?>" class="btn head-btn2">Đăng nhập</a>
                                </div>
                                <?php else: ?>
                                <div class="header-btn d-none f-right d-lg-block">
